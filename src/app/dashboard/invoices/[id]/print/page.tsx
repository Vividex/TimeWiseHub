  ...
  return (
    <>
      <style>{`
          ...
          .invoice-print-page .logo { font-size: 28px; font-weight: 900; color: #0f172a; letter-spacing: -0.5px; }
          .invoice-print-page .logo-img { max-height: 80px; max-width: 240px; object-fit: contain; display: block; background: #fff; }
      ...
      <div className="invoice-print-page">
        ...
        <div className="footer">
          Generated by TimeWiseHub · timewisehub.com.au
        </div>
      </div>
    </>
  )
