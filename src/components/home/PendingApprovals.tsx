          ...
          <Link key={doc.id} href={`/dashboard/invoices/${doc.id}`}
            ...
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-sm font-bold text-gray-900">{doc.invoice_number}</p>
                <p className="text-xs text-gray-400">{nameMap.get(doc.owner_id) ?? 'Unknown'}</p>
              </div>
            </div>
            <div className="flex shrink-0 items-center gap-3">
              ...
              <span className="text-xs font-bold text-cyan-600">Review →</span>
            </div>
          </Link>
        ))}
      </div>
