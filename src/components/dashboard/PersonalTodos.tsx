  ...
  return (
    <div className={`flex items-center gap-3 px-5 py-3 ${hasBorder ? 'border-b border-gray-100 dark:border-slate-800/60' : ''}`}>
      ...
      <div className="flex shrink-0 items-center gap-1">
        <button
          onClick={save}
          className="rounded-lg bg-gradient-to-b from-cyan-500 to-cyan-600 text-white shadow-md shadow-cyan-500/25 transition-all duration-150 hover:from-cyan-600 hover:to-cyan-700 hover:shadow-lg hover:shadow-cyan-500/30 active:scale-[0.965] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-400 px-3 py-1 text-xs font-bold"
        >
          Save
        </button>
        <button
      ...
      <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="flex items-center gap-3 border-b border-gray-100 dark:border-slate-800 px-4 py-3">
          ...
          {text.trim() && (
            <button
              onClick={add}
              className="shrink-0 rounded-lg bg-gradient-to-b from-cyan-500 to-cyan-600 text-white shadow-md shadow-cyan-500/25 transition-all duration-150 hover:from-cyan-600 hover:to-cyan-700 hover:shadow-lg hover:shadow-cyan-500/30 active:scale-[0.965] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-400 px-3 py-1 text-xs font-bold"
            >
              Add
            </button>
          )}
