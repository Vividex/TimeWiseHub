...
export default function AddSessionButton({ clients }: { clients: ClientOption[] }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="w-full max-w-sm rounded-2xl border border-gray-100 bg-white p-6 shadow-xl">
        <h2 className="mb-1 text-lg font-black text-gray-900">New session</h2>
        <p className="mb-4 text-sm text-gray-500">Who is this session for?</p>
        <select
          value={clientId}
        ...
        <div className="flex gap-2 pt-4">
          ...
          <button
            type="button"
            disabled={!clientId}
            onClick={() => router.push(`/dashboard/clients/${clientId}/sessions?new=1`)}
